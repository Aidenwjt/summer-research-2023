...
or simply imply nice properties. The following will be some note worthy Theorems from Evans.
\end{motivation}
...
\end{theorem}
\begin{remark}
Not much to say about this Theorem other than the fact it is very important for the proof of the next Theorem.
\end{remark}
...
Since $n < p \leq \infty$ and $u \in W^{1,p}(U)$ it follows that $u$ is H\"{o}lder continuous allowing us
	to use the H\"{o}lder norm to get an estimate.
\end{remark}
