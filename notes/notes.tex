...
Much of the content is taken from L.C. Evans' Partial Differential Equations, but there is also some content from Gilbarg and Trudinger,
...
\begin{proof}
	...
	Now we wish to find the smallest $t > 0$ that satisfies \href{eq:1}. To do this we can employ Calculus, which says the minimum $t$
...
\begin{definition}[H\"{o}lder spaces]
